...
string referenceProcTTH_="TTH";
string referenceTagWV_="TTHHadronicTag_0";
string referenceTagRV_="TTHHadronicTag_0";
...
int main(int argc, char *argv[]){
  ...
  referenceProcTTH_="TTH";
  referenceTagWV_="TTHHadronicTag_0"; // histest stats WV is ggh Untagged 3. 
  referenceTagRV_="TTHHadronicTag_0"; // fairly low resolution tag even for ggh, more approprioate as te default than re-using the original tag.
